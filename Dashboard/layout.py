                        ...
                        [
                            dbc.Alert(
                                [
                                    ...
                                    "This will permanently mark these dates as non-leak events.",
                                ],
                                color="warning",
                                className="mb-3",
                                style={"fontSize": "clamp(0.875rem, 2vw, 1rem)"},
                            ...
                            dbc.Label(
                                "Reason for ignoring (required):", className="fw-medium"
                            ),
                            dbc.Select(
                            ...
                            dbc.Label("Explanation (required):", className="fw-medium"),
                            dbc.Textarea(
